...
public class HandUI : MonoBehaviour
{
    ...
    private GameObject mainUITimeBoard;

    private GameObject mainUIScoreBoard;
    ...
    void Start()
    {
        ...
        mainUITimeBoard = GameObject.Find("TimeBoard");
        mainUIScoreBoard = GameObject.Find("ScoreBoard");
        ...
        restartGame.onClick.AddListener(() =>
        {
            ...
            // recover the white ball position rotation and remove the speed.
    ...
    void Update()
    {
        timeBoard.GetComponent<TextMeshProUGUI>().text = mainUITimeBoard.GetComponent<TextMeshProUGUI>().text;
        scoreBoard.GetComponent<TextMeshProUGUI>().text = mainUIScoreBoard.GetComponent<TextMeshProUGUI>().text;
    }
}
